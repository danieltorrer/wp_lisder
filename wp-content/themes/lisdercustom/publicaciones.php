...
<div id="publicacion-container">
	...
	<div class="row">
		...
		<div class="large-9 columns isotope-container">
			...
			<div id="id<?php the_id();?>" class="large-12 columns descripcion-articulo <?php echo simple_fecha(); ?> <?php echo str_replace(" ", "_", simple_revista()); ?>" >
